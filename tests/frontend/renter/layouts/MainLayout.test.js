...
describe('Renter MainLayout Component', () => {
    beforeEach(() => {
        localStorage.clear();
    ...
    test('renders navigation bar with tenant title', () => {
        renderWithRouter(<MainLayout />);
        expect(screen.getByText('Tenant / Renter / Applicant')).toBeInTheDocument();
    });
    ...
    test('navigation bar has correct styling', () => {
        renderWithRouter(<MainLayout />);
        const nav = screen.getByText('Tenant / Renter / Applicant').closest('nav');
    ...
    test('main container has correct styling', () => {
        renderWithRouter(<MainLayout />);
        const main = screen.getByText('Tenant / Renter / Applicant').closest('div').querySelector('main');
    ...
    test('logout redirects to login page with correct host', () => {
        renderWithRouter(<MainLayout />);
        ...
        // We can't directly test window.location.href changes in Jest, but we can verify the logic
        expect(logoutButton).toBeInTheDocument();
    });
}); 